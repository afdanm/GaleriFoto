...
<body>
    ...
    <form class="upload-form" action="{{ route('upload-photo') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <label for="title">Judul Foto:</label>
        <input type="text" name="title" id="title" required placeholder="Masukkan judul foto">
